...
- `Spreadsheet::object_info(id)` and `object_reference_info(id)` resolve object ids into compact graph summaries with raw type, grounded role name, and archive path.
